...
<div class="col-md-12">
	<div class="card">
		<div class="card-header">
		    ...
		    <a href="?page=userList" class="btn  btn-secondary">Back to New Registration</a>
			...
			<form action="model/userEditModel.php" method="post" enctype="multipart/form-data">
		            ...
		            <div class="form-group col-md-4">
		                ...
		                <div style="display: block;">
			                <div class="custom-control custom-radio custom-control-inline">
	                            <input required="required" type="radio" id="customRadioInline1" name="customRadioInline1" class="custom-control-input" value="1">
	                            <label class="custom-control-label" for="customRadioInline1">Yes</label>
	                        </div>
	                        <div class="custom-control custom-radio custom-control-inline">
	                            <input required="required" type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input" value="0">
	                            <label class="custom-control-label" for="customRadioInline2">No</label>
	                        </div>
                        </div>

		            	<!-- Yes <input type="radio" class="form-control" required="required" name="allowTrading" value="1">
		               	No <input type="radio" class="form-control" required="required" name="allowTrading" value="0"> -->
		            </div>
		            <div class="form-group col-md-4">
		        ...
		        <div class="form-row">
		        	<div class="form-group col-md-6">
		            	...
		            	<input name="pan_number" type="text" class="form-control mb-2 noBlankSpace" id="inputPassword4" placeholder="PAN Number" value="<?php echo $BANK_DATA_RESULT['pan_number']; ?>">
		            ...
		            <div class="form-group col-md-6">
		            	...
		            	<input name="aadhar_number" type="text" class="form-control mb-2 noBlankSpace onlyNumber" id="inputPassword4" placeholder="Aadhar Number" value="<?php echo $BANK_DATA_RESULT['aadhar_number']; ?>">
